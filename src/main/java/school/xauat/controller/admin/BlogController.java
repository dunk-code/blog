...
public class BlogController {
    ...
    public String delete(@PathVariable Long id, RedirectAttributes attributess) {
        blogService.deleteBlog(id);
        attributess.addFlashAttribute("message", "操作成功");
        return REDIRECT_LIST;
    }
}
